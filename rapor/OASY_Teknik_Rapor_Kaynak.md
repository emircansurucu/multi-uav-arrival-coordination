...
Simülasyon videosu kodların başlatılması, görevlerin yüklenmesi, kalkışlar, seyir, terminal girişi, üç varış ve RTL komutlarını kapsar. Uzun seyir bölümleri 20 kat hızlandırılır; kritik olaylar normal hızda kısa altyazılarla gösterilir. Videonun sonundaki sonuç kartı aynı koşunun olay günlüğünden üretilir.
...
| Geliştirilen Python dosyaları | Agent, kontrol, kestirim, koordinasyon, analiz, rüzgâr ve video betikleri |
...
Teslim ZIP'i oluşturulurken geliştirme ortamındaki `.git`, cache, ham video, eski koşu ve gigabaytlarca SITL logu alınmamalıdır. Yalnız son düzenlenmiş video ile ona ait olay günlüğü kanıt olarak tutulmalıdır. `ardupilot` geliştirme ortamında sembolik bağlantı olduğu için ZIP'e alınmadan önce gerçek kaynak diziniyle değiştirilmelidir.
